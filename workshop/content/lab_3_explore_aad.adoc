...
CAUTION: You must be logged in as an administrator to complete the rest of this lab.
...
CAUTION: Remember to log in as an administrator to complete the rest of the lab.
