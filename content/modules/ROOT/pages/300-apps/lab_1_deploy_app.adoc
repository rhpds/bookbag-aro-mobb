...
While in the route section of the OpenShift Web Console, click the URL under _Location_: image::web-console-route-link.png[OpenShift Web Console - Route Link]
