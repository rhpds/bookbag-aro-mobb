...
oc -n bookinfo apply -f \
  https://raw.githubusercontent.com/rh-mobb/aro-workshop-service-mesh-files/refs/heads/main/bookinfo.yaml
----
+
.Sample Output
[source,text,options=nowrap]
...
https://github.com/rh-mobb/aro-workshop-service-mesh-files/blob/main/bookinfo.yaml[Check it out on GitHub],window=_blank].
...
----
oc -n bookinfo apply -f \
  https://raw.githubusercontent.com/rh-mobb/aro-workshop-service-mesh-files/refs/heads/main/bookinfo-gateway.yaml
----
+
.Sample Output
[source,text,options=nowrap]
...
----
oc -n bookinfo apply -f \
  https://raw.githubusercontent.com/rh-mobb/aro-workshop-service-mesh-files/refs/heads/main/destination-rule-all.yaml
----
+
.Sample Output
[source,text,options=nowrap]
...
+
If you get "Application Unavailable", make sure your browser did not redirect you to HTTPS.
